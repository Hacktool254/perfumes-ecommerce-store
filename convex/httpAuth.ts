...
export const registerHttp = httpAction(async (ctx, request) => {
  ...
  try {
    ...
    const result = await ctx.runMutation(internal.authMutations.register, { name, email, password });
...
export const loginHttp = httpAction(async (ctx, request) => {
  ...
  try {
    ...
    const result = await ctx.runMutation(internal.authMutations.login, { email, password });
...
export const logoutHttp = httpAction(async (ctx, request) => {
  ...
  try {
    ...
    const result = await ctx.runMutation(internal.authMutations.logout, { token });
