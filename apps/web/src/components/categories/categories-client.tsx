                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="absolute inset-0 flex flex-col items-center justify-end text-white p-4 pb-6">
                                        <h3 className="font-serif text-lg md:text-xl mb-1 text-center">{col.name}</h3>
                                        <span className="text-[10px] uppercase tracking-[0.2em] opacity-80 group-hover:opacity-100 transition-opacity">
                                            Shop Now
                                        </span>
                                    </div>
                                </Link>
