...
export function AuthForm({ mode: initialMode, redirectPath = "/account" }: AuthFormProps) {
    ...
    return (
        ...
        .auth-bg {
          ...
          overflow: hidden;
          position: relative;
          background: radial-gradient(ellipse at 60% 40%, oklch(0.92 0.04 85) 0%, oklch(0.97 0.01 85) 60%, oklch(0.88 0.03 85) 100%);
        }
        ...
        .auth-card {
          ...
          box-shadow:
            0 8px 32px rgba(139, 21, 56, 0.10),
        ...
        .auth-input {
          ...
          border: 1.5px solid rgba(139, 21, 56, 0.35);
          border-radius: 999px;
          font-size: 0.875rem;
        ...
        .auth-btn {
          ...
          border: none;
          border-radius: 999px;
          background: linear-gradient(135deg, #8b1538 0%, #c2993c 100%);
          color: #fff;
          font-size: 0.9375rem;
          font-weight: 600;
          cursor: pointer;
        ...
        .auth-btn:hover:not(:disabled) {
          ...
          box-shadow: 0 8px 24px rgba(139, 21, 56, 0.32);
        }
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        style={{ color: "#8b1538", fontWeight: 500, border: "none", background: "none", cursor: "pointer", padding: 0 }}
                                    >
                                        Forgot password?
                                    </button>
                                </div>
