...
- [ ] 1.3 Install and initialize **Convex** (`npx convex dev`) — backend + real-time database
- [ ] 1.4 Configure **TailwindCSS** + **shadcn/ui** in the frontend
...
- [ ] 2.2 Add Convex indexes on: email, product slug, order status, payment transaction ID
